...
| <a name="input_dev_execution_role_arn"></a> [dev\_execution\_role\_arn](#input\_dev\_execution\_role\_arn) | The ARN of the execution role in the Dev account | `string` | n/a | yes |
