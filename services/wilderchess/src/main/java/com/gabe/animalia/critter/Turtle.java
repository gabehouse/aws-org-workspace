...
public class Turtle extends Critter {
	...
	private static String passiveCritterDescription = "Deal all damage directed to Turtle on unbench back to the attacking fighters.";
	...
	public Turtle(String name, Square spot, String side, Player owner, Player opponent) {
		super(name, FighterType.TURTLE, spot, MAX_HEALTH, MAX_FATIGUE, abilities, side, owner, opponent,
