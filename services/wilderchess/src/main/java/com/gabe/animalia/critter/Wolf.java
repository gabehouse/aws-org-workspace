...
public class Wolf extends Critter {
	...
	public Wolf(String name, Square spot, String side, Player owner, Player opponent) {
		super(name, FighterType.WOLF, spot, MAX_HEALTH, MAX_FATIGUE, abilities, side, owner, opponent,
	...
	public void unbenchEffect(Player player, Player otherPlayer) {
		...
		Meld meldTemplate = new Meld(this, this, player, otherPlayer);
		Meld meld = (Meld) meldTemplate.getNew();
		meld.setContext(this, this, player, otherPlayer);
		meld.customPerform();
	}
}
