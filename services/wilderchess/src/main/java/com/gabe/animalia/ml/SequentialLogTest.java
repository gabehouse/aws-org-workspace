...
//         final String GAME_ID = "TEST-" + UUID.randomUUID().toString().substring(0, 8);
...
//         PlayerActionInput input1 = new PlayerActionInput(PLAYER_A, Arrays.asList(action1));
...
//         System.out.println("You should see two files: " + GAME_ID + "_turns_slim.json and " + GAME_ID + "_result.json");
//     }
